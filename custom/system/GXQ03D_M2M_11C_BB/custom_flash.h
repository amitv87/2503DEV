 ...
 *******************************************************************************/
#define REGION_INFO_LAYOUT    {0x1000, 96},

#ifndef __NVRAM_BACKUP_PARTITION__
#define DISK0_REGION_INFO_LAYOUT    {0x1000, 96},
#define DISK1_REGION_INFO_LAYOUT    {0x1000, 96},
#endif
...
#define BANK_INFO_LAYOUT    {0x60000, 1}, \
